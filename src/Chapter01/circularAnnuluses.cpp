// original; circularAnnuluses.cpp by Sumanta Guha.
//
...
void drawOriginalAnnuluses() {
  ...
  // Upper right circular annulus: the white disc is in front of the red disc
  // blocking it.
  glEnable(GL_DEPTH_TEST); // Enable depth testing.
  glColor3f(1.0, 1.0, 1.0);
  drawDisc(10.0, 75.0, 75.0,
           0.5);            // Compare this z-value with that of the red disc.
  glColor3f(1.0, 0.0, 0.0);
...
void drawBullsEyeTarget() {
  // Upper right circular annulus: the white disc is in front of the red disc
  // blocking it.
  glEnable(GL_DEPTH_TEST);
  glColor3f(0.0, 0.0, 0.0);
  drawDisc(5.0, 50.0, 50.0, 0.5);
  glColor3f(0.8, 0.8, 0.2);
  drawDisc(10.0, 50.0, 50.0, 0.4);
  glColor3f(0.2, 0.3, 0.8);
  drawDisc(15.0, 50.0, 50.0, 0.3);
  glColor3f(0.8, 0.3, 0.2);
  drawDisc(20.0, 50.0, 50.0, 0.2);
  glColor3f(0.3, 0.8, 0.2);
  drawDisc(25.0, 50.0, 50.0, 0.1);
  glDisable(GL_DEPTH_TEST); // Disable depth testing.
}
...
void drawScene(void) {
  glClear(GL_COLOR_BUFFER_BIT |
          GL_DEPTH_BUFFER_BIT); // Clear the buffers including the depth buffer.
...
void printInteraction(void)
{
  ...
  std::cout << "Press the space bar to toggle between wirefrime and filled for "
               "the lower annulus."
            << std::endl;
}
